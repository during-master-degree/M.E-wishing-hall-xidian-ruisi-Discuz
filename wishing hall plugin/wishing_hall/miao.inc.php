...
*************************/	
	$random_rewards=ceil((($credit)*9*mt_rand(0,100)/100+mt_rand(0,100)/100)*2);
...
*************************/		
		if($exacr && $exacz) {
			...
			sign_msg("进贡上传量 {$credit} GB {$lang[tsn_18]} 筹码 {$random_rewards} .".$another_vip,"plugin.php?id=wishing_hall:miao");
		}
//	}
}
